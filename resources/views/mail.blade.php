...
<body>
    <table style='max-width: 800px; width: 100%; font-family: "Montserrat"; margin: 0 auto;'>
        <tr>
            <td width="400px">
                <div style="background-color: #fb5373; color: #fff; padding: 15px;">
                    <div>
            ...
            <td width="400px" style='color: #fb5373;font-size: 50px;font-weight: 700;text-align: center;'>RubyRose</td>
        </tr>
    </table>
    <br />
    <br />
    ...
    <table style='max-width: 800px; width: 100%; font-family: "Montserrat"; margin: 0 auto;'>
        <tr>
            <td style="text-align: center">
                ...
                <div
                    style='background-color: #ffaeb5;height: 100px;color: #fff;max-width: 600px;margin: 0 auto;-webkit-box-shadow: -6px -6px #fb5373;-moz-box-shadow: -14px -11px #fb5373;box-shadow: -14px -11px #fb5373;'>
                    <p style="padding: 8px">
